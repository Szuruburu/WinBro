...
; Font settings
GUIRegularFont(guiname, color:="c0111111") {
	Gui, %guiname%: Font, %color% s10 w500 q5, Franklin Gothic Medium Cond
}

GUISmallFont(guiname, color:="c0656565") {
	Gui, %guiname%: Font, %color% s8 w500 q5, Franklin Gothic Medium Cond
}

GuiBigPixelFont(guiname, color:="c0111111") {
	Gui, %guiname%: Font, %color% s15 w1950 q5, Terminal
}