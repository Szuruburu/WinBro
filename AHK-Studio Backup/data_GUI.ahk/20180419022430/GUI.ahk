SplashScreen:
	...
	Gui, SplashScreen: Add, Picture, x0 y53 w%width% h9, %A_ScriptDir%\data\gui\help\wd_separator.gif
	;AnimatedGif(SC_hwnd, A_ScriptDir "\data\gui\floani.gif", 5, 0 , 100, 100)
	GuiBigPixelFont("SplashScreen",color_main_text)
	Gui, SplashScreen: Add, Text, x%text_margin_left% y20 BackgroundTrans, % apptitle
	GUIRegularFont("SplashScreen",color_main_text)
	Gui, SplashScreen: Add, Text, x%text_margin_left% y40 BackgroundTrans, % "He's your bro!"
	GUISmallFont("SplashScreen",color_main_text)
	Gui, SplashScreen: Add, Text, x%text_margin_left% y65 BackgroundTrans, % author ", v: " version
