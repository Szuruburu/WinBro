SplashScreen:
	...
	Gui, SplashScreen: Add, Text, x%text_margin_left% y+20 BackgroundTrans, % "He's your bro!"
	GUISmallFont("SplashScreen",color_main_text)
	Gui, SplashScreen: Add, Text, x%text_margin_left% y+15 BackgroundTrans, % author ", v: " version
