SplashScreen:
	...
	Gui, SplashScreen: Add, Text, x%text_margin_left% y+-4 BackgroundTrans, % "He's your bro!"
	GUISmallFont("SplashScreen",color_main_text)
	Gui, SplashScreen: Add, Text, x%text_margin_left% y+6 BackgroundTrans, % DrawLine("-",6) "`nversion: " version "`n" author 
