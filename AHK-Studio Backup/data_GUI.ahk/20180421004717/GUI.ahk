...
GenRndStrFromFile(input_file) {
	Loop, Read, %A_ScriptDir%\data\%descpath%
	{
		Array%index% := A_LoopReadLine
		index++
	}
}
...
SplashScreen:
	...
	Gui, SplashScreen: Add, Text, x%text_margin_left% y+-4 x+-100 BackgroundTrans, % GenRndStrFromFile(A_ScriptDir "\data\rndmsg.txt")
