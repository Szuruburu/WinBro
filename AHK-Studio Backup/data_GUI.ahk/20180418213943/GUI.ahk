...
SplashScreen:
	author := % DrawLine("-",60) . "`nauthor: szuru.buru@hotmaiil.com"
	splash_width := 350
	splash_height := 100
	...
	WinSet, ExStyle, +0x20
	Gui, SplashScreen: Color,% "0x" g_cBlue
	AnimatedGif(SC_hwnd, A_ScriptDir "\data\gui\floani.gif", 5, 0 , 100, 100)
	GuiBigPixelFont("SplashScreen","111111")
	Gui, SplashScreen: Add, Text, x%text_margin_left% y20 BackgroundTrans, % AppTitle " v" Version
	GUIRegularFont("SplashScreen","b51422")
	Gui, SplashScreen: Add, Text, x%text_margin_left% y43 BackgroundTrans, capslock + H
	GUISmallFont("SplashScreen","117091")
...
GuiBigPixelFont(guiname,color:=111111) {
	Gui, %guiname%: Font, c0%color% s13 w400 q5, Consola Mono
}
