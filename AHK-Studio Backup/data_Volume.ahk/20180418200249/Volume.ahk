...
VolumeShow:
	...
	if !WinExist("ahk_id " VOLUME_hwnd) {
		...
		shadow_offset_h := % volH + margin
		shadow_offset_w := % volW + margin
		Gui, VolBackdrop: Show, % "w" volW + margin " h" shadow_offset_h " NoActivate"
		WinMoveFunc(VOLBDP_hwnd,"hc vc",-3,3)
