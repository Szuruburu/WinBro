...
VolumeShow:
	...
	&& !WinExist("ahk_id " VOLUME_hwnd {
		...
		shadow_offset_x := 0
		shadow_offset_y := shadow_offset / 2
		...
		WinFade("ahk_id " VOLBDP_hwnd,160,35)
		...
		WinFade("ahk_id " VOLUME_hwnd, volT,23)
	} else {
		GoSub, VolumeDestroy
	}
...
VolumeDestroy:
	...
	|| (WinExist("ahk_id" VOLBDP_hwnd)) {
		...
		WinFade("ahk_id " VOLUME_hwnd,0,20)
		WinFade("ahk_id " VOLBDP_hwnd,0,15)
		Gui, Volume: Destroy
