...
VolumeShow:
	...
	if !WinExist("ahk_id " VOLUME_hwnd) {
		...
		Gui, VolBackdrop: Show, % "w" volW + margin " h" volH + margin " NoActivate"
		WinMoveFunc(VOLBDP_hwnd,"hc vc",-5,5)
...
WinFade("ahk_id " VOLUME_hwnd, 0, 10)
WinFade("ahk_id " VOLBDP_hwnd, 0, 20)
Gui, Volume: destroy
