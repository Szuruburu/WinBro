...
RunCode:
	...
	Hotkey, %mod_main% & , SplashScreenTest
	...
	Hotkey, %modk_main% & %navAuxUp%, GEN_xHome_aScrollLeft_sToTheTop
	Hotkey, %modk_main% & %navAuxDown%, GEN_xHome_aScrollRight_sToTheBottom
