...
SettingsWindow:
	if (WinExist("ahk_id " SET_hwnd)) {
		...
		Gui, Settings: Add, Tab3, % "x" tabs_x " y" tabs_y " w" tabs_w " h" tabs_h " vtabs_handler", Navigation|KDE Window Effects|About
		Gui, Settings: Tab, 1
		...
		Gui, Settings: Add, GroupBox, % "x" g_x " y" g1_y " h" g1_h " vg1_handler", % "Window Lock"
		GUIRegularFont("Settings")
		...
		Gui, Settings: Add, Slider, % "y" g1_y + p " w" 140 " h" 30 " vKDE_WindowLock_Transparency gUpdateWLTSliderVar Range1-255 Tooltip", % KDE_WindowLock_Transparency
		
		GUIHeaderFont("Settings")
		Gui, Settings: Add, GroupBox, % "x" g_x " y" g1_y + g1_h + p_ms " h" g2_h " vg2_handler", % "KDE Move / KDE Resize"
		GUIRegularFont("Settings")
		...
		Gui, Settings: Add, Slider, % "w" 140 " h" 30 " vKDE_winfade_opacity gUpdateWLTSliderVar Range1-255 Tooltip", % KDE_winfade_opacity
		...
		Gui, Settings: Add, Slider, % "w" 140 " h" 30 " vKDE_winfade_time_in gUpdateWLTSliderVar Range1-25 Tooltip", % KDE_winfade_time_in
		...
		Gui, Settings: Add, Slider, % "w" 140 " h" 30 " vKDE_winfade_time_out gUpdateWLTSliderVar Range1-25 Tooltip", % KDE_winfade_time_out
...
SettingsGuiSize:
	...
	GuiControl, Settings: Move, g1_handler, % "w" g_w
	GuiControl, Settings: Move, g2_handler, % "w" g_w
	...
	GuiControlGet, g1_pos, Settings: Pos, g1_handler
	GuiControlGet, g2_pos, Settings: Pos, g2_handler
